...
import PumpGame from "../pump-game";
import PumpHistoryTable from "../pump-history";
import LivePumpWins from "../../../../components/live-wins-pump";
  ...
  return (
    <div>
      ...
      <div className="w-full mt-10 space-y-4">
        ...
        {activeTab === "my-bets" && <PumpHistoryTable />}
        {activeTab === "live-games" && <LivePumpWins />}
      </div>
    </div>
  );
}
