...
import GlassHistoryTable from "../glass-history";
import LiveGlassWins from "../../../../components/live-wins-glass";
  ...
  return (
    <div>
      ...
      <div className="w-full mt-10 space-y-4">
        ...
        {activeTab === "my-bets" && <GlassHistoryTable />}
        {activeTab === "live-games" && <LiveGlassWins />}
      </div>
    </div>
  );
}
