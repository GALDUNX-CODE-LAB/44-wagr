...
import MinesHistoryTable from "../mines-history";
import LiveMinesWins from "../../../../components/live-wins-mines";
  ...
  return (
    <div>
      ...
      <div className="w-full mt-10 space-y-4">
        ...
        {activeTab === "my-bets" && <MinesHistoryTable />}
        {activeTab === "live-games" && <LiveMinesWins />}
      </div>
    </div>
  );
}
