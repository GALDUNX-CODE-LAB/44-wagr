  ...
  return (
    <div className="flex flex-col flex-1 min-h-0 gap-2 p-3 overflow-hidden text-[#ededed]">
      <div className="flex flex-col gap-2 shrink-0">
        ...
        <AnimatePresence>
          {inActiveGame && (
            <motion.div
              ...
              className="order-5 md:order-4 shrink-0"
            >
        ...
        <div className="order-6 md:order-5 shrink-0">
        ...
        {isIdle ? (
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            onClick={onBet}
            className="order-1 md:order-6 w-full py-2.5 rounded font-semibold text-xs tracking-wide text-[#131212]"
            style={{
          ...
          <div className="order-1 md:order-6 flex flex-col gap-1.5">
            {canCashout && (
              <motion.button
                type="button"
                whileTap={{ scale: 0.97 }}
                onClick={onCashout}
                className="w-full py-2 rounded font-semibold text-[11px] tracking-wide"
                style={{
