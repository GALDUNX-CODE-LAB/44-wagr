...
const WithdrawalHistoryCard = () => {
  ...
  if (loading) {
    return (
      <div className="w-full h-auto min-h-[352px] bg-[#212121] border border-white/10 rounded-[20px] p-4 sm:p-6 flex items-center justify-center">
  ...
  return (
    <div className="w-full h-auto min-h-[352px] bg-[#212121] border border-white/10 rounded-[20px] p-4 sm:p-6">
            ...
            <table className="w-full">
              ...
              <tbody>
                {currentTransactions.map((tx) => (
                  <tr key={tx._id} className="text-white text-xs lg:text-sm hover:bg-white/5 transition-colors">
