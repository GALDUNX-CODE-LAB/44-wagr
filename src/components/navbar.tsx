        ...
        <div className="w-full max-w-[1440px] mx-auto px-4 lg:px-13 py-4 sm:flex sm:justify-end sm:pl-[35%]">
          ...
          {sidebarOpen && (
            <div className="sm:hidden mt-4 bg-[#1C1C1C] border border-white/15 rounded-lg p-4 text-white space-y-4">
              ...
              {/* Date Range */}
              <button className="flex items-center cursor-pointer bg-[#c8a2ff] gap-2 px-3 py-2 rounded-full border border-white/20 text-black text-sm w-full"
          ...
          <div className="hidden sm:flex items-center gap-3">
            ...
            {/* Date */}
            <button className="flex items-center gap-2 px-3 bg-[#c8a2ff]  py-2 rounded-full border border-white/20 text-black text-sm"
